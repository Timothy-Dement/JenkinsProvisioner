                                        ...
                                        else
                                        {
                                            ...
                                            EC2.associateAddress(associateAddressParams, function(err, data)
                                            {
                                                ...
                                                else
                                                {
                                                    ...
                                                    // fs.writeFile('/home/vagrant/share/keys/checkbox.key', privateKey, function(err)
                                                    // {
                                                    ...
                                                    //         fs.chmod('/home/vagrant/share/keys/checkbox.key', 0600, function(err)
                                                    //         {
                                                    ...
                                                    // inventory += ' ansible_ssh_private_key_file=./keys/checkbox.key';
                                                    ...
                                                    // var ansible_defaults = `checkbox_ip_address: ${publicIpAddress}`;
